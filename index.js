...
import chair_model from './models/chair_maya.gltf';
...
const colors = [
  {
    texture: require('./img/wood_.jpg'),
    size: [2, 2, 2],
    shininess: 60,
  },
  {
    texture: require('./img/leather_Base_color.jpg'),
    size: [1, 1, 1],
    shininess: 60,
  },

  {
    texture: require('./img/fabric_.jpg'),
    size: [4, 4, 4],
    shininess: 0,
  },

  {
    texture: require('./img/pattern_.jpg'),
    size: [8, 8, 8],
    shininess: 10,
  },

  {
    texture: require('./img/denim_.jpg'),
    size: [3, 3, 3],
    shininess: 0,
  },

  {
    texture: require('./img/quilt_.jpg'),
    size: [6, 6, 6],
    shininess: 0,
  },
